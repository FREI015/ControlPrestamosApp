...
fun EditLoanScreen(
    ...
    Column(
        ...
        AppPrimaryButton(
            ...
            onClick = {
                val cleanName = normalizeTextInput(fullName)
                ...
                val cleanConditions = conditions.trim()
                ...
                val newTotal = if (amount != null && percentage != null) {
                ...
                when {
                    !validateRequiredText(cleanName) -> {
                        errorMessage = "Debes colocar el nombre del cliente."
                    }
                    ...
                    percentage == null || percentage < 0.0 -> {
                        errorMessage = "El porcentaje no es válido."
                    }

                    loanLocalDate == null -> {
                        errorMessage = "La fecha del préstamo no es válida."
                    }

                    dueLocalDate == null -> {
                        errorMessage = "La fecha de vencimiento no es válida."
                    }

                    dueLocalDate.isBefore(loanLocalDate) -> {
                        errorMessage = "La fecha de vencimiento no puede ser menor que la fecha del préstamo."
                    }

                    loan.paidAmount > newTotal -> {
                        errorMessage = "No puedes guardar un préstamo cuyo nuevo total quede por debajo de lo ya abonado. Ajusta el monto o el porcentaje."
                    }
