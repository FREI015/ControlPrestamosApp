            ...
            AppSectionCard {
                ...
                AppPrimaryButton(
                    ...
                    onClick = {
                        ...
                        val cleanReason = normalizeTextInput(reason)
                        val cleanNotes = notes.trim()

                        when {
                            cleanName.isBlank() -> errorMessage = "Debes colocar el nombre."
                            cleanReason.isBlank() -> errorMessage = "Debes colocar el motivo."
