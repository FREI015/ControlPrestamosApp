            ...
            AppSectionCard {
                ...
                AppPrimaryButton(
                    ...
                    onClick = {
                        ...
                        val cleanAccount = normalizeTextInput(bankAccount)
                        val cleanMobilePayment = sanitizePhoneInput(mobilePaymentPhone)
                        val cleanAlias = normalizeTextInput(paymentAlias)
                        val cleanNotes = notes.trim()

                        when {
                            cleanName.isBlank() -> errorMessage = "Debes colocar el nombre del usuario."
                            !hasPaymentData() -> errorMessage = "Debes guardar al menos un dato de pago."
