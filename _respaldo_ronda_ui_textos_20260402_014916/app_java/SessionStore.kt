...
class SessionStore(context: Context) {
    ...
    companion object {
        ...
        private val allowedHistoryPrefixes = listOf(
            "Perfil actualizado",
            "PrÃƒÂ©stamo registrado",
            "PrÃƒÂ©stamo actualizado",
            "PrÃƒÂ©stamo cobrado",
            "PrÃƒÂ©stamo perdido",
            "PrÃƒÂ©stamo eliminado",
            "PrÃƒÂ©stamo enviado a papelera",
            "PrÃƒÂ©stamo restaurado",
            "Papelera depurada",
            "Pago registrado",
    ...
    fun savePin(pin: String) {
        ...
        require(normalized.length in 4..6) { "El PIN debe tener entre 4 y 6 dÃƒÂ­gitos." }
    ...
    fun readOperationalHistory(): List<String> {
        ...
        return readHistoryRecords()
            ...
            .map { record -> "${formatHistoryTimestamp(record.createdAt)} Ã‚Â· ${record.message}" }
    }
